...
// External engines (FLM subprocess, remote APIs) have no files in the models
// dir — deleting them is meaningless, so their cards get no Delete button.
const isExternalEngine = (model: ModelInfo): boolean =>
  model.engine_type === "FlmWhisper" ||
