...
/// The full paste-method option set for the current OS, shared by the global
/// Output setting and the Transcribe & Submit group.
export const buildPasteMethodOptions = (
