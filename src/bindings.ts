...
export const commands = {
  ...
  async changePortableAutostartConsentSetting(
    consent: PortableAutostartConsent,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_portable_autostart_consent_setting", {
          consent,
        }),
      };
    } catch (e: unknown) {
  ...
  async changeAutomaticUpdateChecksSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_automatic_update_checks_setting", {
          enabled,
        }),
      };
    } catch (e: unknown) {
  ...
  async changeAutomaticSilentUpdatesSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_automatic_silent_updates_setting", {
          enabled,
        }),
      };
    } catch (e: unknown) {
  ...
  async changeSilentUpdateTimeLocalSetting(
    value: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_silent_update_time_local_setting", {
          value,
        }),
      };
    } catch (e: unknown) {
  ...
  async changeSilentUpdateJitterMinutesSetting(
    minutes: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        ...
        data: await TAURI_INVOKE(
          "change_silent_update_jitter_minutes_setting",
          { minutes },
        ),
      };
    } catch (e: unknown) {
  ...
  async changeAppThemeSetting(theme: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_app_theme_setting", { theme }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changePasteMethodSetting(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_paste_method_setting", { method }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changePasteMethodPttSetting(
    method: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_paste_method_ptt_setting", { method }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeExternalScriptPathSetting(
    path: string | null,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_external_script_path_setting", {
          path,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitPasteMethodSetting(
    method: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_paste_method_setting", {
          method,
        }),
      };
    } catch (e) {
  ...
  async changePasteLastPasteMethodSetting(
    method: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_paste_last_paste_method_setting", {
          method,
        }),
      };
    } catch (e) {
  ...
  async changePasteLastClipboardHandlingSetting(
    handling: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_paste_last_clipboard_handling_setting",
          { handling },
        ),
      };
    } catch (e) {
  ...
  async changeSubmitKeySetting(key: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_key_setting", { key }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeSubmitIdleBehaviorSetting(
    behavior: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_idle_behavior_setting", {
          behavior,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitClipboardHandlingSetting(
    handling: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_clipboard_handling_setting", {
          handling,
        }),
      };
    } catch (e) {
  ...
  async changeClipboardRestoreDelaySetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_clipboard_restore_delay_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitClipboardRestoreDelaySetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_submit_clipboard_restore_delay_setting",
          { delay },
        ),
      };
    } catch (e) {
  ...
  async changeClipboardRestoreDelayRemoteSetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_clipboard_restore_delay_remote_setting",
          { delay },
        ),
      };
    } catch (e) {
  ...
  async changeJumperSubmitDelaySetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_submit_delay_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeJumperPasteDelaySetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_paste_delay_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeJumperSubmitDelayRemoteSetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_submit_delay_remote_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeJumperPasteDelayRemoteSetting(
    delay: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_paste_delay_remote_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async setJumperRemoteMatchStrings(
    strings: string[],
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_jumper_remote_match_strings", {
          strings,
        }),
      };
    } catch (e) {
  ...
  async changeReturnFocusSetting(
    flow: string,
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_return_focus_setting", {
          flow,
          enabled,
        }),
      };
  ...
  async jumpToSlot(slot: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("jump_to_slot", { slot }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeJumperPersistSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_persist_setting", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeAnchorActionSlotSetting(
    key: string,
    slot: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_anchor_action_slot_setting", {
          key,
          slot,
        }),
      };
  ...
  async changeJumperTrackSetting(
    flow: string,
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_track_setting", {
          flow,
          enabled,
        }),
      };
  ...
  async changeJumperTrackSlotSetting(
    flow: string,
    slot: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_track_slot_setting", {
          flow,
          slot,
        }),
      };
  ...
  async changeJumperSaveCursorSlot(
    slot: number,
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_save_cursor_slot", {
          slot,
          enabled,
        }),
      };
  ...
  async changeJumperCursorModeSlot(
    slot: number,
    mode: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_jumper_cursor_mode_slot", {
          slot,
          mode,
        }),
      };
  ...
  async changeAnchorRequireSameFlow(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_anchor_require_same_flow", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeTranslatorModelUnloadTimeout(
    timeout: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_translator_model_unload_timeout", {
          timeout,
        }),
      };
    } catch (e) {
  ...
  async changeTranslatorModelUnloadCustomSeconds(
    seconds: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_translator_model_unload_custom_seconds",
          { seconds },
        ),
      };
    } catch (e) {
  ...
  async getTranslatorStatus(): Promise<Result<TranslatorStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_translator_status"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeTranslatorEnabled(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_translator_enabled", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeTranslatorPriority(
    priority: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_translator_priority", { priority }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeTranslatorModel(modelId: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_translator_model", { modelId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async translatorAddFolder(path: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("translator_add_folder", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async translatorSetFolderEnabled(
    path: string,
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("translator_set_folder_enabled", {
          path,
          enabled,
        }),
      };
  ...
  async changeAnchorActionSetting(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_anchor_action_setting", {
          key,
          action,
        }),
      };
  ...
  async changeCancelBehaviorSetting(
    behavior: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_cancel_behavior_setting", {
          behavior,
        }),
      };
    } catch (e) {
  ...
  async changeTranscriptionModeSetting(
    mode: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_transcription_mode_setting", { mode }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeTranscriptionModePttSetting(
    mode: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_transcription_mode_ptt_setting", {
          mode,
        }),
      };
    } catch (e) {
  ...
  async changeTranscribeGpuDeviceSetting(
    device: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_transcribe_gpu_device_setting", {
          device,
        }),
      };
    } catch (e) {
  ...
  async changeApiTranscriptionUrlSetting(
    url: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_api_transcription_url_setting", {
          url,
        }),
      };
    } catch (e) {
  ...
  async changeApiTranscriptionKeySetting(
    key: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_api_transcription_key_setting", {
          key,
        }),
      };
    } catch (e) {
  ...
  async changeApiTranscriptionModelSetting(
    model: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_api_transcription_model_setting", {
          model,
        }),
      };
    } catch (e) {
  ...
  async changeOpenrouterTranscriptionUrlSetting(
    url: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_openrouter_transcription_url_setting",
          { url },
        ),
      };
    } catch (e) {
  ...
  async changeOpenrouterTranscriptionKeySetting(
    key: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_openrouter_transcription_key_setting",
          { key },
        ),
      };
    } catch (e) {
  ...
  async changeOpenrouterTranscriptionModelSetting(
    model: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_openrouter_transcription_model_setting",
          { model },
        ),
      };
    } catch (e) {
  ...
  async changeOpenrouterTranscriptionRouteSetting(
    route: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_openrouter_transcription_route_setting",
          { route },
        ),
      };
    } catch (e) {
  ...
  async changeOpenrouterTranscriptionAudioFormatSetting(
    format: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_openrouter_transcription_audio_format_setting",
          { format },
        ),
      };
    } catch (e) {
  ...
  async updateModelTestLibrary(
    library: ModelTestLibrary,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_model_test_library", { library }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async setPostProcessProviderRef(
    providerId: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_post_process_provider_ref", {
          providerId,
        }),
      };
    } catch (e) {
  ...
  async changePostProcessTemperatureSetting(
    temperature: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_post_process_temperature_setting", {
          temperature,
        }),
      };
    } catch (e) {
  ...
  async changePreserveTranscriptionsSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_preserve_transcriptions_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeOutputPrefixEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_prefix_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeOutputPrefixTextSetting(
    text: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_prefix_text_setting", { text }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeOutputPrefixNewlineSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_prefix_newline_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeOutputSuffixEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_suffix_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeOutputSuffixTextSetting(
    text: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_suffix_text_setting", { text }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeOutputSuffixNewlineSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_output_suffix_newline_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitPrefixEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_prefix_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitPrefixTextSetting(
    text: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_prefix_text_setting", { text }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeSubmitPrefixNewlineSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_prefix_newline_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitSuffixEnabledSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_suffix_enabled_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeSubmitSuffixTextSetting(
    text: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_suffix_text_setting", { text }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeSubmitSuffixNewlineSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_submit_suffix_newline_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeCaptureSourceSetting(
    source: string,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_capture_source_setting", { source }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeSystemAudioDeviceSetting(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_system_audio_device_setting", {
          deviceName,
        }),
      };
    } catch (e) {
  ...
  async changeSystemAudioDelayMsSetting(
    delayMs: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_system_audio_delay_ms_setting", {
          delayMs,
        }),
      };
    } catch (e) {
  ...
  async changeSystemAudioGainSetting(
    gain: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_system_audio_gain_setting", { gain }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeTypingChunkCharsSetting(
    chars: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_typing_chunk_chars_setting", {
          chars,
        }),
      };
    } catch (e) {
  ...
  async changeTypingChunkDelaySetting(
    delay: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_typing_chunk_delay_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeCrashResilientRecordingSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_crash_resilient_recording_setting", {
          enabled,
        }),
      };
    } catch (e) {
  ...
  async changeTypingStartDelaySetting(
    delay: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_typing_start_delay_setting", {
          delay,
        }),
      };
    } catch (e) {
  ...
  async changeTypingKeyDelaySetting(
    delay: number,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_typing_key_delay_setting", { delay }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changePostProcessDisableThinkingSetting(
    enabled: boolean,
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE(
          "change_post_process_disable_thinking_setting",
          { enabled },
        ),
      };
    } catch (e) {
  ...
  async countTokens(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("count_tokens", { text, tokenizer }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setTypingText(text: string): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_typing_text", { text }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async startTyping(delaySecs: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("start_typing", { delaySecs }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async countTokensViaProvider(
    providerId: string,
    text: string,
  ): Promise<Result<ProviderCountResult, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("count_tokens_via_provider", {
          providerId,
          text,
        }),
      };
  ...
  async countTokensAllProviders(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("count_tokens_all_providers", {
          text,
          parallel,
        }),
      };
  ...
  async cancelTokenCountSweep(): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("cancel_token_count_sweep"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async listProviderModels(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("list_provider_models", { providerId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async listOpenrouterTranscriptionModels(
    providerId: string,
  ): Promise<Result<string[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("list_openrouter_transcription_models", {
          providerId,
        }),
      };
    } catch (e) {
  ...
  async readTextFileForCount(path: string): Promise<Result<string, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("read_text_file_for_count", { path }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<ModelTestRun, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("run_model_test", {
          system,
          prompt,
          providerIds,
          temperature,
  ...
  async writeTextFile(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("write_text_file", { path, contents }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
   ...
   */
  async fetchOpenrouterModelPrices(): Promise<
    Result<OpenRouterModelPrice[], string>
  > {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("fetch_openrouter_model_prices"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async setMcpEnabled(enabled: boolean): Promise<Result<McpStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("set_mcp_enabled", { enabled }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async changeMcpPort(port: number): Promise<Result<McpStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("change_mcp_port", { port }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateLlmProviders(
    providers: LlmProvider[],
  ): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_llm_providers", { providers }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async backfillHistoryDurations(): Promise<Result<number, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("backfill_history_durations"),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateHistoryLimit(limit: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("update_history_limit", { limit }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async updateRecordingRetentionPeriod(
    period: string,
  ): Promise<Result<null, string>> {
    try {
      return {
  ...
  async createBackup(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_backup", { profile, destPath }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  ): Promise<Result<RestoreReport, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("restore_backup", {
          archivePath,
          includeConfig,
          includeRecordings,
        }),
  ...
  async installAvailableUpdate(): Promise<Result<UpdaterStatus, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("install_available_update"),
      };
    } catch (e: unknown) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: String(e) };
...
export type AppSettings = {
  ...
  portable_autostart_consent?: PortableAutostartConsent;
  automatic_update_checks?: boolean;
  automatic_silent_updates?: boolean;
  silent_update_time_local?: string;
  silent_update_jitter_minutes?: number;
  typing_start_delay_secs?: number;
  typing_key_delay_ms?: number;
  typing_chunk_chars?: number;
  typing_chunk_delay_ms?: number;
  ...
  model_unload_custom_seconds?: number;
  word_correction_threshold?: number;
  history_limit?: number;
  recording_retention_period?: RecordingRetentionPeriod;
  paste_method?: PasteMethod;
  paste_method_ptt?: PasteMethod;
  clipboard_handling?: ClipboardHandling;
  paste_last_paste_method?: PasteMethod;
  paste_last_clipboard_handling?: ClipboardHandling;
  auto_submit?: boolean;
   ...
   */
  post_process_temperature?: number;
  ...
  preserve_transcriptions?: boolean;
  capture_source?: CaptureSource;
  system_audio_device?: string | null;
  system_audio_gain?: number;
  system_audio_delay_ms?: number;
  output_prefix_enabled?: boolean;
  output_prefix_text?: string;
  output_prefix_newline?: boolean;
  output_suffix_enabled?: boolean;
  output_suffix_text?: string;
  output_suffix_newline?: boolean;
  submit_prefix_enabled?: boolean;
  submit_prefix_text?: string;
  submit_prefix_newline?: boolean;
  submit_suffix_enabled?: boolean;
  submit_suffix_text?: string;
  submit_suffix_newline?: boolean;
  crash_resilient_recording?: boolean;
  app_language?: string;
  ...
  transcription_mode_ptt?: TranscriptionMode;
  api_transcription_url?: string;
  api_transcription_key?: string;
  api_transcription_model?: string;
  ...
  openrouter_transcription_route?: OpenRouterTranscriptionRoute;
  openrouter_transcription_audio_format?: TranscriptionAudioFormat;
  openrouter_transcription_url?: string;
  openrouter_transcription_key?: string;
  openrouter_transcription_language?: string;
  openrouter_transcription_translate_to_english?: boolean;
  api_transcription_language?: string;
  api_transcription_translate_to_english?: boolean;
  custom_asr_config_migrated?: boolean;
  /**
  ...
  submit_paste_method?: PasteMethod;
  submit_key?: AutoSubmitKey;
  submit_idle_behavior?: SubmitIdleBehavior;
  cancel_behavior?: CancelBehavior;
  submit_clipboard_handling?: ClipboardHandling;
  clipboard_restore_delay?: ClipboardRestoreDelay;
  clipboard_restore_delay_remote?: ClipboardRestoreDelay | null;
  submit_clipboard_restore_delay?: ClipboardRestoreDelay;
  jumper_submit_delay?: JumperSubmitDelay;
  jumper_paste_delay?: JumperPasteDelay;
  jumper_submit_delay_remote?: JumperSubmitDelay;
  jumper_paste_delay_remote?: JumperPasteDelay;
  jumper_remote_match_strings?: string[];
  return_focus_output?: boolean;
  return_focus_submit?: boolean;
  anchor_return_focus?: boolean;
  anchor_action_output_idle?: AnchorAction;
  anchor_action_output_stop?: AnchorAction;
  anchor_action_submit_idle?: AnchorAction;
  anchor_action_submit_stop?: AnchorAction;
  anchor_action_output_idle_slot?: number;
  anchor_action_output_stop_slot?: number;
  anchor_action_submit_idle_slot?: number;
  anchor_action_submit_stop_slot?: number;
  jumper_track_enabled?: boolean;
  jumper_track_slot?: number;
  jumper_track_output?: boolean;
  jumper_track_submit?: boolean;
  jumper_track_output_enabled?: boolean;
  jumper_track_output_slot?: number;
  jumper_track_submit_enabled?: boolean;
  jumper_track_submit_slot?: number;
  jumper_save_cursor_slots?: boolean[];
  jumper_cursor_mode_slots?: CursorMode[];
  anchor_on_finish_require_same_flow?: boolean;
  jumper_cursor_mode?: CursorMode;
  jumper_v2_migrated?: boolean;
  jumper_v3_migrated?: boolean;
  jumper_v4_migrated?: boolean;
  translator_enabled?: boolean;
  translator_folders?: TranslatorFolder[];
  translator_seeded?: boolean;
  translator_priority?: TranslatorPriority;
...
export type SubmitIdleBehavior =
  | "start_normal"
  | "do_nothing"
  | "start_and_submit";
/**
...
export type ClipboardRestoreDelay =
  | "none"
  | "ms100"
  | "ms200"
  | "ms250"
 ...
 */
export type ModelTestLibrary = {
  model_prompts?: NamedText[];
  judge_prompts?: NamedText[];
  presets?: ModelTestPreset[];
};
/**
 ...
 */
export type ModelTestPreset = {
  id: string;
  name: string;
  model_prompt_id?: string | null;
