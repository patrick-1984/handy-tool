...
_Note: this is a bit tedious and hacky atm, but I hope it will be improved with time_
...
- [ ] **Add Copilot/GPT-3 integration**
  ...
  _"refactor this using stl containers"_

  or

  _"optimize by sorting the data first"_
