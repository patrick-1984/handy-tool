...
:: ============================================================
:: Handy - Development Server Script
:: ============================================================
:: Same prerequisites as build.cmd
:: Frontend hot-reloads on save; Rust recompiles incrementally
:: ============================================================
...
echo.
echo Starting Handy dev server (Ctrl+C to stop)...
echo.
