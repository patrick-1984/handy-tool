...
Static slots repeat the pair on each numbered card, for example `Jumper › Static slot 1 › Set Jump Slot 1` and `Jumper › Static slot 1 › Jump to Slot 1` _{Windows only}_.
