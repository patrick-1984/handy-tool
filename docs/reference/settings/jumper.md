...
`Jumper › Hot slot (Anchor & Deliver) › Current anchor` _{Windows only}_
...
`Jumper › Hot slot (Anchor & Deliver) › Save mouse position` _{Windows only}_
...
`Jumper › Hot slot (Anchor & Deliver) › Cursor position mode` _{Windows only}_
...
`Jumper › Second hot slot (Anchor & Deliver) › Current anchor` _{Windows only}_
...
`Jumper › Second hot slot (Anchor & Deliver) › Save mouse position` _{Windows only}_
...
`Jumper › Second hot slot (Anchor & Deliver) › Cursor position mode` _{Windows only}_
...
`Jumper › Persistence › Remember slots across restarts` _{Windows only}_
...
`Jumper › On-finish behavior › Only jump on finish if started the same way` _{Windows only}_
...
`Jumper › Static slot 1 › Set Jump Slot 1` _{Windows only}_
...
`Jumper › Static slot 1 › Jump to Slot 1` _{Windows only}_
...
`Jumper › Static slot 1 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 1 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 2 › Set Jump Slot 2` _{Windows only}_
...
`Jumper › Static slot 2 › Jump to Slot 2` _{Windows only}_
...
`Jumper › Static slot 2 › Slot 2 target` _{Windows only}_
...
`Jumper › Static slot 2 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 2 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 3 › Set Jump Slot 3` _{Windows only}_
...
`Jumper › Static slot 3 › Jump to Slot 3` _{Windows only}_
...
`Jumper › Static slot 3 › Slot 3 target` _{Windows only}_
...
`Jumper › Static slot 3 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 3 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 4 › Set Jump Slot 4` _{Windows only}_
...
`Jumper › Static slot 4 › Jump to Slot 4` _{Windows only}_
...
`Jumper › Static slot 4 › Slot 4 target` _{Windows only}_
...
`Jumper › Static slot 4 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 4 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 5 › Set Jump Slot 5` _{Windows only}_
...
`Jumper › Static slot 5 › Jump to Slot 5` _{Windows only}_
...
`Jumper › Static slot 5 › Slot 5 target` _{Windows only}_
...
`Jumper › Static slot 5 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 5 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 6 › Set Jump Slot 6` _{Windows only}_
...
`Jumper › Static slot 6 › Jump to Slot 6` _{Windows only}_
...
`Jumper › Static slot 6 › Slot 6 target` _{Windows only}_
...
`Jumper › Static slot 6 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 6 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 7 › Set Jump Slot 7` _{Windows only}_
...
`Jumper › Static slot 7 › Jump to Slot 7` _{Windows only}_
...
`Jumper › Static slot 7 › Slot 7 target` _{Windows only}_
...
`Jumper › Static slot 7 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 7 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 8 › Set Jump Slot 8` _{Windows only}_
...
`Jumper › Static slot 8 › Jump to Slot 8` _{Windows only}_
...
`Jumper › Static slot 8 › Slot 8 target` _{Windows only}_
...
`Jumper › Static slot 8 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 8 › Cursor position mode` _{Windows only}_
...
`Jumper › Static slot 9 › Set Jump Slot 9` _{Windows only}_
...
`Jumper › Static slot 9 › Jump to Slot 9` _{Windows only}_
...
`Jumper › Static slot 9 › Slot 9 target` _{Windows only}_
...
`Jumper › Static slot 9 › Save mouse position` _{Windows only}_
...
`Jumper › Static slot 9 › Cursor position mode` _{Windows only}_
