...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_clipboard_restore_delay_remote_setting,
        shortcut::change_jumper_submit_delay_setting,
        shortcut::change_jumper_paste_delay_setting,
        shortcut::change_jumper_submit_delay_remote_setting,
        ...
        shortcut::change_openrouter_transcription_url_setting,
        shortcut::change_openrouter_transcription_key_setting,
        ...
        shortcut::change_output_suffix_enabled_setting,
        shortcut::change_output_suffix_text_setting,
        shortcut::change_output_suffix_newline_setting,
        shortcut::change_submit_prefix_enabled_setting,
        shortcut::change_submit_prefix_text_setting,
        shortcut::change_submit_prefix_newline_setting,
        shortcut::change_submit_suffix_enabled_setting,
        shortcut::change_submit_suffix_text_setting,
        shortcut::change_submit_suffix_newline_setting,
        shortcut::change_typing_chunk_chars_setting,
        shortcut::change_typing_chunk_delay_setting,
